...
| [0004](0004-playable-interface-and-adapter-boundary.md) | Accepted | Use a framework-free local browser interface with a thin application-only adapter and Vite build tooling |
